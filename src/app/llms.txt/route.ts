...
- Import support: CSV export from Chrome, Bitwarden, LastPass, or similar — parsed entirely client-side, never uploaded raw.
- License: PolyForm Noncommercial License 1.0.0. Free for any noncommercial use, including self-hosting a fully private instance with your own database. Commercial use (selling it, offering it as a paid hosted service, bundling it into a paid product) requires a separate agreement with the copyright holder.
- Distribution: web app (installable as a PWA via "Add to Home Screen"), and a native Android app (Trusted Web Activity) distributed directly via GitHub Releases rather than the Play Store.
